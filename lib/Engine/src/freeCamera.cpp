...
void FreeCamera::calculateProjectionMatrix(D3DXMATRIX& projectionMatrix, float nP, float fP) {
	float aspect = 4.0f / 3.0f;
	D3DXMatrixPerspectiveFovLH( &projectionMatrix, D3DX_PI/4, aspect, nP, fP );
}
